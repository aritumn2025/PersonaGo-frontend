...
function CalmDashboard({ user, history, results }: CalmDashboardProps) {
    ...
    >
      ...
      <div className="relative">
        <Image
          ...
          src="/images/dashboard/calm/flash.svg"
      ...
      >
        ...
        <div className="relative -mx-2 h-56">
          ...
          <Image
            ...
            src="/images/dashboard/calm/islands/profile.svg"
            alt="Passionate Dashboard"
            width={300}
            height={150}
          />
          ...
          <div className="absolute top-36 left-18 z-[2] text-sm font-bold text-black">
            <QRCodeDrawer id={user.id}>
              <Image
                src="/images/dashboard/calm/buttons/fullscreen.svg"
                alt="QRコード拡大"
                width={40}
                height={40}
              />
          ...
          <Image
            ...
            src="/images/dashboard/calm/islands/anotherPersonality.svg"
            alt="Passionate Dashboard"
            width={150}
            height={75}
          />
          ...
          >
            <Image
              src="/images/dashboard/calm/buttons/next.svg"
              alt="他性格"
              width={40}
              height={40}
            />
        ...
        <div className="relative -mx-2 -mt-12 h-36">
          ...
          <Image
            ...
            src="/images/dashboard/calm/tags/suggest.svg"
            alt="suggest tag"
            width={200}
            height={100}
          />
          ...
          <Image
            ...
            src="/images/dashboard/calm/islands/suggest.svg"
            alt="Passionate Dashboard"
            width={275}
            height={150}
          />
        ...
        <div className="relative -mx-2 mb-14 h-24">
          ...
          <Image
            ...
            src="/images/dashboard/calm/tags/score.svg"
            alt="score tag"
            width={200}
            height={100}
          />
          ...
          <Image
            className="absolute top-0 left-0"
            src="/images/dashboard/calm/islands/score.svg"
            alt="Passionate Dashboard"
            width={200}
            height={100}
          />
        ...
        <div className="relative -mx-2 h-36">
          ...
          <Image
            ...
            src="/images/dashboard/calm/tags/history.svg"
            alt="history tag"
            width={200}
            height={100}
          />
          ...
          <Image
            ...
            src="/images/dashboard/calm/islands/history.svg"
            alt="Passionate Dashboard"
            width={300}
            height={150}
          />
